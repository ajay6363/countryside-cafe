							...
							<ul class="gn-menu agile_menu_drop">
								...
								<li>
									...
									<ul class="gn-submenu">
										...
										<li class="mini_list_w3"><a href="customer.php"> <i class="fa fa-caret-right" aria-hidden="true"></i> ADD PRODUCT</a></li>
		...
		<!-- /inner_content-->
				<div class="inner_content">
					...
					<div class="inner_content_w3_agile_info two_in">
					  <h2 class="w3_inner_tittle">Add Product</h2>

							<!--/forms-->
													<div class="forms-main_agileits">
														
															<div class="graph-form agile_info_shadow">
															 <h3 class="w3_inner_tittle two">Product Details </h3>
																	<div class="form-body">
																		<form  action="productinteraction.php" method="post"enctype="multipart/form-data"> 
																		<div class="form-group"> <label>Product Name</label>
																		<input type="text" name="name"class="form-control" placeholder="Name">
																		</div>
																		<div class="form-group"> <label>Product Discription</label>
																		<textarea name="discription"class="form-control" placeholder="discription"></textarea>
																		</div>
																		<div class="form-group">
																		<label for="exampleInputFile">image input</label> 
																		<input type="file" name="file" id="exampleInputFile"> <p class="help-block">Insert image of the product.</p> </div>
																		<div class="form-group">
																		...
																		<input type="number" name="disc" class="form-control" placeholder="percentage%">
																		</div>
