		...
		<!-- /inner_content-->
				<div class="inner_content">
					...
					<div class="inner_content_w3_agile_info two_in">
					  <h2 class="w3_inner_tittle">Add employee</h2>
															...
															<div class="graph-form agile_info_shadow">
															 <h3 class="w3_inner_tittle two">employee Form </h3>
																	<div class="form-body">
																		...
																		Female <input type="radio" value="female" name="Male">
																		</div> 
																		
																		<div class="form-group">
																		<label for="exampleInputFile">File input</label> 
																		<input type="file" name="file" id="exampleInputFile"> <p class="help-block">Insert image of the employee.</p> </div>
