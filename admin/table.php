					  ...
					  <h2 class="w3_inner_tittle">Tables</h2>
									...
									<div class="agile-tables">
										<div class="w3l-table-info agile_info_shadow">
										 <h3 class="w3_inner_tittle two">EMPLOYEES DETAIL</h3>
										<div class="text-right"> <a href="pdf.php"> <button type = "button" class = "btn btn-warning">Download PDF</button></a>  <a href="word.php"><button type = "button" class = "btn btn-primary">Download WORD</button></a></div>
										  ...
										  <?php
											...
											while($row=$res->fetch_assoc())
										   {
											  ...
											  <tr>
												...
												<td><a href="downloadfile.php?id=<?php echo $row["file"];?>">    <img src="<?php echo"images/" . $row["file"];?>" height="100px" width="200px"></a></td>
												<td><a href="edit.php?id=<?php echo $row["employee_id"];?>" type = "button" class = "btn btn-success">Edit</a></td>
                                                <td><a href="delete.php?id=<?php echo $row["employee_id"];?>" type = "button" class = "btn btn-danger" onclick="return confirm('are you sure?')">Delete</a></td>
