					...
					<nav class="gn-menu-wrapper">
						<div class="gn-scroller scrollbar1">
							<ul class="gn-menu agile_menu_drop">
								...
								<li>
									<a href="#"><i class="fa fa-cogs" aria-hidden="true"></i> EMPLOYEES <i class="fa fa-angle-down" aria-hidden="true"></i></a> 
									<ul class="gn-submenu">
										<li class="mini_list_agile"><a href="input.php"><i class="fa fa-caret-right" aria-hidden="true"></i>INSERT EMPLOYEES</a></li>
										<li class="mini_list_w3"><a href="table.php"> <i class="fa fa-caret-right" aria-hidden="true"></i> VIEW EMPLOYEES</a></li>
										<li class="mini_list_w3"><a href="customer.php"> <i class="fa fa-caret-right" aria-hidden="true"></i> CUSTOMER REPORT</a></li>
										<li class="mini_list_w3"><a href="addproduct.php"> <i class="fa fa-caret-right" aria-hidden="true"></i> ADD PRODUCT</a></li>
										<li class="mini_list_w3"><a href="viewproduct.php"> <i class="fa fa-caret-right" aria-hidden="true"></i> VIEW PRODUCT</a></li>
									</ul>
								</li>
								<li>
		...
		<!-- /inner_content-->
				<div class="inner_content">
					...
					<div class="inner_content_w3_agile_info two_in">
					  <h2 class="w3_inner_tittle">Edit employee</h2>

							<!--/forms-->
													<div class="forms-main_agileits">
														
															<div class="graph-form agile_info_shadow">
															 <h3 class="w3_inner_tittle two">employee Form </h3>
																	<div class="form-body">
																	
																	<?php
																	 require("connection.php");
																	 $id=$_REQUEST["id"];
																	 $res=$con->query("select*from tb_employee where employee_id=$id");
																	 $count=$res->num_rows;
																	 if($count>0)
																	 {$row=$res->fetch_assoc();
																	 }?>
																		...
																		<input type="number" value="<?php echo $row["age"];?>" name="age" class="form-control" placeholder="Age">
																		</div> 
																		<div class="form-group">
																		<label for="exampleInputPassword1">Phoneno</label> 
																		<input type="number" value="<?php echo $row["phoneno"];?>" name="phoneno" class="form-control" placeholder="phone number">
																		</div>  
																		<div class="form-group"> 
																		<label> Gender </label>
																		<?php
																		...
																		{
																	    ?>
																		Female<input type="radio" name="Male" value="male">
																	
																		<input type="radio" name="Male" value="female"checked>
																		</div> 
																		<?php
																		}
																		?>
																		...
																		<img src="<?php echo"images/" . $row["file"];?>" height="100px" width="200px">
																		<input type="file" name="file" value="<?php echo $row["file"];?>" id="exampleInputFile"> <p class="help-block">Insert image of the employee.</p> </div>
