...
<div class="wthree_agile_admin_info">
		  ...
		  <div class="w3_agileits_top_nav">
			<ul id="gn-menu" class="gn-menu-main">
				...
				<!-- //nav_agile_w3l -->
				<li class="second logo"><h1><a href="dashboard.php"><i class="fa fa-graduation-cap" aria-hidden="true"></i><p><?php echo $asha?></p> </a></h1></li>
...
<div class="copyrights">
	 <p>© 2023 | Design by Ajaynarayanan.S >W3layouts</a> </p>
</div>	
